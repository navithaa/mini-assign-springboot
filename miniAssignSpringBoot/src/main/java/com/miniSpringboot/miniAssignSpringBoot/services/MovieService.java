package com.miniSpringboot.miniAssignSpringBoot.services;

import com.amazonaws.services.dynamodbv2.AmazonDynamoDB;
import com.opencsv.CSVReader;
import com.opencsv.exceptions.CsvValidationException;
import com.miniSpringboot.miniAssignSpringBoot.models.Movie;
import com.miniSpringboot.miniAssignSpringBoot.repositories.MovieRepository;
...
public class MovieService {
    ...
    @Scheduled(fixedDelay = 24 * 60 * 60 * 1000) // Execute the task daily, adjusting the delay as necessary

    public void syncData() {
        //This code reads the CSV file and retrieves the latest details of the movies.
        List<Movie> newMovies = readCsv();

        // Synchronize the updated movie details with the datastore
    ...
    public List<String> getEnglishTitlesWithUserReviewsGreaterThan(int userReviewFilter) {
        ...
        try {
            ...
            // Retrieve English titles that have user reviews surpassing the specified filter
            List<Map<String, AttributeValue>> filteredItems = items.stream()
                    .filter(item -> {
                        ...
                        // Verify if the attribute values are not null
            ...
            // Arranging the filtered items in descending order based on user reviews
    ...
    public List<String> getHighestBudgetTitlesForYearAndCountry(String year, String country) {
        ...
        try {
            ...
            // Filtering the items by year and country
            ...
            // Sorting the items by budget in desc order
